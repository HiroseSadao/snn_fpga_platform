...
void _run_exc_spike_resetter_codeobject()
{
...
const double theta_plus = 5e-05;
const size_t _numv = 50;
const double v_reset = - 0.065;
const size_t _numnot_refractory = 50;
	...
	const int32_t *_events = _ptr_array_exc__spikespace;
	const int32_t _num_events = _ptr_array_exc__spikespace[N];
