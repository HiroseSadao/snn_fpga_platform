...
void _run_inh_spike_resetter_codeobject()
{
...
const size_t _numnot_refractory = 50;
	...
	const int32_t *_events = _ptr_array_inh__spikespace;
	const int32_t _num_events = _ptr_array_inh__spikespace[N];
