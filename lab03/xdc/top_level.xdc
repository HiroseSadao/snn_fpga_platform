...
set_property -dict {PACKAGE_PIN K16 IOSTANDARD LVCMOS33}  [ get_ports "debug_sample_waiting" ]
set_property -dict {PACKAGE_PIN J16 IOSTANDARD LVCMOS33}  [ get_ports "debug_uart_busy" ]
