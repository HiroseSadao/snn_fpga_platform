...
module sd_controller(
    ...
    parameter CMD8_R1 = 7;
    parameter CMD58 = 8;
    parameter CMD58_R1 = 9;
    parameter READ_EXTRA = 10;
    parameter CMD58_DONE = 11;
    
    parameter IDLE = 12;
    parameter READ_BLOCK = 13;
    parameter READ_BLOCK_WAIT = 14;
    parameter READ_BLOCK_DATA = 15;
    parameter READ_BLOCK_CRC = 16;
    parameter SEND_CMD = 17;
    parameter RECEIVE_BYTE_WAIT = 18;
    parameter RECEIVE_BYTE = 19;
    parameter WRITE_BLOCK_CMD = 20;
    parameter WRITE_BLOCK_INIT = 21;
    parameter WRITE_BLOCK_DATA = 22;
    parameter WRITE_BLOCK_BYTE = 23;
    parameter WRITE_BLOCK_WAIT = 24;
        ...
        if(reset == 1) begin
            ...
            case(state)
                ...
                CMD8: begin
                    ...
                    bit_counter <= 55;
                    return_state <= CMD8_R1;
                    state <= SEND_CMD;
                end
                CMD8_R1: begin
                    extra_data <= 32'd0;
                    extra_count <= 2'd3;
                    extra_next_state <= CMD55;
                    bit_counter <= 7;
                    return_state <= READ_EXTRA;
                    state <= RECEIVE_BYTE;
                end
                CMD55: begin
                ...
                CMD58: begin
                    ...
                    bit_counter <= 55;
                    return_state <= CMD58_R1;
                    state <= SEND_CMD;
                end
                CMD58_R1: begin
                    extra_data <= 32'd0;
                    extra_count <= 2'd3;
                    extra_next_state <= CMD58_DONE;
                    bit_counter <= 7;
                    return_state <= READ_EXTRA;
                    state <= RECEIVE_BYTE;
                end
                CMD58_DONE: begin
                    high_capacity <= extra_data[30];
                    state <= IDLE;
                end
                IDLE: begin
                    if(rd == 1) begin
                ...
                READ_BLOCK: begin
                    cmd_out <= {16'hFF_51, read_addr, 8'hFF};
                    bit_counter <= 55;
                ...
                READ_EXTRA: begin
                    extra_data <= {extra_data[23:0], recv_data};
                    if (extra_count == 0) begin
                        state <= extra_next_state;
                    end
                    else begin
