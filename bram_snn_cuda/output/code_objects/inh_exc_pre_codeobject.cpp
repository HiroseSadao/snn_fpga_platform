...
void _run_inh_exc_pre_codeobject()
{
...
const size_t _num_postsynaptic_idx = _dynamic_array_inh_exc__synaptic_post.size();
    ///// POINTERS ////////////
    ...
    {
    std::vector<int> *_spiking_synapses = inh_exc_pre.peek();
    ...
    
    {
            ...
            _spiking_synapse_idx++)
        {
            ...
            const int32_t _postsynaptic_idx = _ptr_array_inh_exc__synaptic_post[_idx];
            double gi_post = _ptr_array_exc_gi[_postsynaptic_idx];
            gi_post += 17.0;
            _ptr_array_exc_gi[_postsynaptic_idx] = gi_post;
...
void _debugmsg_inh_exc_pre_codeobject()
{
    using namespace brian;
    std::cout << "Number of synapses: " << _dynamic_array_inh_exc__synaptic_pre.size() << endl;
}
