...
const double _lio_statement_1 = 10.0 * ms;


const int _N = _array_inp_exc_N[0];
...
for(int _idx=0; _idx<_N; _idx++)
{
    ...
    if (_cond)
    {
        ...
        double delay;
        delay = _lio_statement_1 * _rand(_vectorisation_idx);
        _ptr_array_inp_exc_delay[_idx] = delay;
