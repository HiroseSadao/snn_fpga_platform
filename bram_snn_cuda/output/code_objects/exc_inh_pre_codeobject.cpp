...
void _run_exc_inh_pre_codeobject()
{
...
const size_t _num_postsynaptic_idx = _dynamic_array_exc_inh__synaptic_post.size();
    ///// POINTERS ////////////
        
    int32_t* __restrict  _ptr_array_exc_inh__synaptic_pre = _array_exc_inh__synaptic_pre;
    double* __restrict  _ptr_array_inh_ge = _array_inh_ge;
    ...
    {
    std::vector<int> *_spiking_synapses = exc_inh_pre.peek();
    ...
    
    {
            ...
            _spiking_synapse_idx++)
        {
            ...
            const int32_t _postsynaptic_idx = _ptr_array_exc_inh__synaptic_post[_idx];
            double ge_post = _ptr_array_inh_ge[_postsynaptic_idx];
            ge_post += 10.4;
            _ptr_array_inh_ge[_postsynaptic_idx] = ge_post;
...
void _debugmsg_exc_inh_pre_codeobject()
{
    using namespace brian;
    std::cout << "Number of synapses: " << _dynamic_array_exc_inh__synaptic_pre.size() << endl;
}
