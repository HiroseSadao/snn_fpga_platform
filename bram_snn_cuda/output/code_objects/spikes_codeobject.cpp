...
const size_t _num_source_i = 50;
const int64_t _source_start = 0;
const int64_t _source_stop = 50;
const size_t _num_source_t = 1;
const size_t _num_spikespace = 51;
const size_t _numcount = 50;
int32_t* const _array_spikes_i = _dynamic_array_spikes_i.empty()? 0 : &_dynamic_array_spikes_i[0];
const size_t _numi = _dynamic_array_spikes_i.size();
double* const _array_spikes_t = _dynamic_array_spikes_t.empty()? 0 : &_dynamic_array_spikes_t[0];
const size_t _numt = _dynamic_array_spikes_t.size();
const size_t _num_source_idx = 50;
    ///// POINTERS ////////////
        
    int32_t*   _ptr_array_spikes_N = _array_spikes_N;
    double*   _ptr_array_defaultclock_t = _array_defaultclock_t;
    int32_t* __restrict  _ptr_array_exc_i = _array_exc_i;
    int32_t* __restrict  _ptr_array_exc__spikespace = _array_exc__spikespace;
    int32_t* __restrict  _ptr_array_spikes_count = _array_spikes_count;
    int32_t* __restrict  _ptr_array_spikes_i = _array_spikes_i;
    double* __restrict  _ptr_array_spikes_t = _array_spikes_t;
    int32_t* __restrict  _ptr_array_spikes__source_idx = _array_spikes__source_idx;


    //// MAIN CODE ////////////

    int32_t _num_events = _ptr_array_exc__spikespace[_num_spikespace-1];
    ...
    if (_num_events > 0)
    {
        ...
        {
            const int _idx = _ptr_array_exc__spikespace[_j];
        ...
        if (_num_events > 0) {
            ...
            {
                const size_t _idx = _ptr_array_exc__spikespace[_j];
                const size_t _vectorisation_idx = _idx;
                                
                const int32_t _source_i = _ptr_array_exc_i[_idx];
                const int32_t _to_record_i = _source_i;
                const double _to_record_t = _source_t;

                _dynamic_array_spikes_i.push_back(_to_record_i);
                _dynamic_array_spikes_t.push_back(_to_record_t);
                _ptr_array_spikes_count[_idx-_source_start]++;
            }
            _ptr_array_spikes_N[0] += _num_events;
        }
    }
...
void _debugmsg_spikes_codeobject()
{
    using namespace brian;
    const size_t _numN = 1;
const size_t _num_clock_t = 1;
...
const size_t _num_source_idx = 50;
    ...
    std::cout << "Number of spikes: " << _ptr_array_spikes_N[0] << endl;
}
